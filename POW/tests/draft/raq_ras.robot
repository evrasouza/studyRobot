...
...    https://can-am.brp.com/off-road/ca/en/=${DATA_CAN_AM_OFF_EN}
...    https://can-am.brp.com/off-road/ca/fr/=${DATA_CAN_AM_OFF_FR}
...    https://can-am.brp.com/off-road/us/en/=${DATA_CAN_AM_OFF_EN}
...    https://can-am.brp.com/off-road/us/es/=${DATA_CAN_AM_OFF_ES}
...
Fill Quote Form
    Fill Text                ${IFRAME_SELECTOR} >>> [id="form_input_first_name"]    First Name
    Fill Text                ${IFRAME_SELECTOR} >>> [id="form_input_last_name"]     Last Name
    Fill Text                ${IFRAME_SELECTOR} >>> [id="form_input_email"]         email@example.com
    Select Options By        ${IFRAME_SELECTOR} >>> [id="form_input_country_code"]  value   +55
    Fill Text                ${IFRAME_SELECTOR} >>> [id="form_input_phone"]         19981906752
    #Select Options By        ${IFRAME_SELECTOR} >>> [id="form_input_custom1"]       value    CA
    Fill text                ${IFRAME_SELECTOR} >>> [id="form_input_custom2"]       Madame Toussauds 234 West 42nd Street
    Fill Text                ${IFRAME_SELECTOR} >>> [id="form_input_custom3"]       New York
    Select Options By        ${IFRAME_SELECTOR} >>> [id="form_input_custom4"]       value    ON
    Fill Text                ${IFRAME_SELECTOR} >>> [id="form_input_custom5"]       M5H 2N2
